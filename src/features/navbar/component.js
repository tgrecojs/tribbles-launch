const Navbar = () => (
  <div className="flex h-32 justify-between items-center">
    <h2 className="font-kanit text-white font-normal text-3xl ">
    ...
    <div>
      <div className="flex items-center">
        ...
        {/* <a href="#" aria-description="discord logo">
          <svg
            className="m-6 transition-all ease-in-out fill-sky-300 hover:fill-white hover:scale-150"
            viewBox="0 0 640 512"
          >
        ...
        >
          <svg
            className="m-6 transition-all ease-in-out fill-local_pink hover:scale-150"
            viewBox="0 0 512 512"
          >
