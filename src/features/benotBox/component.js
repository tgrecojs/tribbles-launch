...
const AIIconWithLottie = () => {
  ...
  useEffect(() => {
    fetch(
      "https://res.cloudinary.com/dl2adjye7/raw/upload/v1716903515/wired-outline-2512-artificial-intelligence-ai-alt_ju52yt.json"
    )
    ...
    >
      ...
      <div className="text-left p-6 mt-4">
        ...
        <p className="text-gray-400 text-lg">
          Seamlessly integrate AI to enhance your productivity and efficiency.
        </p>
      </div>
    </div>
  );
...
const BentoBox1 = () => {
  ...
  return (
    <div className="h-screen text-center bg-[#000008] flex justify-center items-center min-h-screen p-5 rounded-lg">
