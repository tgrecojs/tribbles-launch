...
const App = ({
  ...
  <Layout>
    <div className="flex flex-col w-full md:w-2/3 items-center md:items-start p-4">
    ...
    <div className="flex flex-col w-full justify-center font-kanit font-extralight items-center">
      <h2 className="text-4xl text-white font-kanit p-10">Tribble Lore </h2>
      <p className="w-full p-4 md:w-2/3 text-white text-2xl">
        {" "}
      ...
      <p className="w-full p-4 md:w-2/3 text-white text-2xl">
        ...
        replicating themselves into generational fortitude. With each new block
        forged in the cosmic ledger, a new generation of Tribbles emerges, ready
        to populate the digital universe with their unique brand of joy and
        unity. Their proliferation is not just a function of their design but a
        testament to their enduring charm and the deep-seated communal bonds
        they foster.
      </p>
    </div>
    <div className="flex flex-col w-full items-center p-20">
